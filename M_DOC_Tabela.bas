...
Public Function GerarTextoTabelaAnalitica(dadosPropriedade As Object, dadosTecnico As Object) As String
    ...
    ' C�lculo de �rea usando fun��o Geo_Area_Gauss (coordenadas UTM)
    ...
    textoFinal = textoFinal & "�rea medida e demarcada: " & vbTab & Format(areaHa, "#,##0.0000") & " hectares" & vbCrLf
    ...
    If loPrincipal.ListRows.Count > 0 Then
        For i = 1 To loPrincipal.ListRows.Count
            ...
            ' L� coordenadas UTM diretamente da tabela principal
    ...
    textoFinal = textoFinal & "Per�metro: " & Format(perimetroTotal, "#,##0.00 m") & vbCrLf
    textoFinal = textoFinal & "�rea m�: " & Format(areaM2, "#,##0.00 m�") & vbCrLf
    textoFinal = textoFinal & "�rea ha: " & Format(areaHa, "#,##0.0000 ha") & vbCrLf & vbCrLf
...
Public Sub GerarTabelaAnaliticaWord(dadosPropriedade As Object, dadosTecnico As Object, Optional gerarComoPDF As Boolean = False)
    ...
    With wordApp.Selection
        ...
        With tblHeader
            ...
            .cell(1, 1).Range.Text = "Im�vel:"
            .cell(1, 2).Range.Text = dadosPropriedade("Denomina��o")

            .cell(2, 1).Range.Text = "Propriet�rio:"
            .cell(2, 2).Range.Text = dadosPropriedade("Propriet�rio")

            .cell(3, 1).Range.Text = "Munic�pio:"
            .cell(3, 2).Range.Text = dadosPropriedade("Munic�pio/UF")
            ...
            .cell(6, 1).Range.Text = "�rea medida e demarcada:"
            .cell(6, 2).Range.Text = Format(areaHa, "#,##0.0000") & " hectares"

            .cell(7, 1).Range.Text = "Per�metro demarcado:"
            .cell(7, 2).Range.Text = Format(perimetroTotal, "#,##0.00") & " metros"

            ' Formata��o: Coluna 1 normal, Coluna 2 negrito
            Dim r As Long
            For r = 1 To 7
        ...
        numLinhasTabela = loPrincipal.ListRows.Count + 1  ' +1 cabe�alho
        ...
        With tblWord
            ...
            ' Corpo da tabela - L� coordenadas diretamente da tabela principal
            If loPrincipal.ListRows.Count > 0 Then
                For i = 1 To loPrincipal.ListRows.Count
    ...
    ' --- TABELA DE RODAP� (2 linhas x 1 coluna) ---
    With wordApp.Selection
        .TypeParagraph
        .TypeParagraph
        .TypeParagraph
        ...
        With tblRodape
            ...
            .cell(1, 1).Range.Text = "Per�metro: " & Format(perimetroTotal, "#,##0.00 m")
            .cell(2, 1).Range.Text = "�rea: " & Format(areaM2, "#,##0.00 m�") & "    �rea: " & Format(areaHa, "#,##0.0000 ha")
        End With
    End With
    
    ' Move o cursor para FORA da tabela de rodap�
    Set rng = wordDoc.Content
    rng.Collapse wdCollapseEnd
    rng.Select
